                            ...
                            <div className="flow-root pb-6">
                                {cartItems.length > 0 ? (
                                    <ul role="list" className="divide-y divide-gray-200 dark:divide-gray-700">
                                        {cartItems.map((item) => (
                                            <li key={`${item.id}-${item.location}-${item.name}`} className="py-6 flex">
                                                ...
                                                <div className="ml-4 flex-1 flex flex-col">
                                                    ...
                                                    <div className="flex-1 flex items-end justify-between text-sm">
                                                        ...
                                                        <div className="flex">
                                                            <button onClick={() => removeFromCart(item.id, item.location, item.name)} type="button" className="font-medium text-indigo-600 hover:text-indigo-500 dark:text-indigo-400 dark:hover:text-indigo-300">
